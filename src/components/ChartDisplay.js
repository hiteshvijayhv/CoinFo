    ...
    return (
        <div className='body'>
            ...
            <div className='daysButtons'>
                <Button variant="dark" onClick={() => changeChartDuration(1)}>1D</Button>
                <Button variant="dark" onClick={() => changeChartDuration(7)}>7D</Button>
                <Button variant="dark" onClick={() => changeChartDuration(30)}>1M</Button>
                <Button variant="dark" onClick={() => changeChartDuration(365)}>1Y</Button>
            </div>
            {!prices ? (
                <div>Loading...</div>
            ) : (
